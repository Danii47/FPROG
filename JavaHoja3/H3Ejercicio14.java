...
/*
  ...
  (supuestamente correctos), y devuelva la cadena de caracteres que contiene la
  fecha en formato largo con el nombre del mes, como por ejemplo "Domingo, 31
  de diciembre de 2023".
*/

import java.util.Scanner;

public class H3Ejercicio14 {
  public static void main(String[] args) {
    ...
    System.out.println("La fecha es: " + longDate);
  ...
  public static String getLongDate(String day, int dayNumber, int month, int year) {
    ...
    return (day + ", " + dayNumber + " del " + monthString + " de " + year);
  }
}
